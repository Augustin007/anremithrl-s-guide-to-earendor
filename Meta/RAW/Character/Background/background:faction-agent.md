...
**Equipment:** The badge or emblemValue:5gp Weight:0 of your faction, a copy of a seminal faction text (or a code-book for a covert faction), a set of common clothesValue:5sp Weight:3lbs, and a pouchValue:5sp Weight:1lb containing 15gp
Features
========
Factions of the Sword Coast
...
Suggested Characteristics
=========================
Use the tables for the [[background:acolyte|acolyte]] background as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity. (For instance, consider the words "faith" and "faction" to be interchangeable.)
