...
**Equipment:** A monster hunter’s packContents:  
...
3 Torches - Value:1cp Weight:1lb (individually), and one trinket of special significance (choose one or roll on the Gothic Trinkets table). Also gain a set of set of common clothesValue:5sp Weight:3lbs and 1sp.
Features
========
Harrowing Event
