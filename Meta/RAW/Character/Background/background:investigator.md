...
**Equipment:** A magnifying glassValue:100gp, evidence from a past case (choose one or roll for a trinket from the [[trinkets|horror trinkets table]]) a set of common clothesValue:5sp Weight:3lbs, and 10gp.
Path to Mystery
===============
