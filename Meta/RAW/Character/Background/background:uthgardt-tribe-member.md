...
**Equipment:** A hunting trapValue:5gp Weight:25lbs, a totemic token or set of tattoos marking your loyalty to Uthgar and your tribal totem, a set of traveler's clothesValue:2gp Weight:4lbs, and a pouchValue:5sp Weight:1lb containing 10gp
Features
========
Barbarian Tribes of Faerûn
Though this section details the Uthgardt specifically, either it or the [[background:outlander|outlander]] background can be used for a character whose origin lies with one of the other barbarian tribes in Faerûn.
