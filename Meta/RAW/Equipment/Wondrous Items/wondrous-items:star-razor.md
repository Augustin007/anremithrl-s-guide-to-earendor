...
* You can cast the [[Meta/RAW/Character/Extra_Abilities/Spells/spell:Fly|fly]] spell from the sword as an action, and the save DC for spells cast using the sword increases to 17.