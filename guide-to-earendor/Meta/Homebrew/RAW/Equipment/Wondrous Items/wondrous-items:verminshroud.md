...
* As an action, you can use the verminshroud to cast [[Meta/Homebrew/RAW/Character/Extra_Abilities/Spells/spell:Polymorph|polymorph]] on yourself, transforming into a **giant rat** or **rat** while retaining your Intelligence, Wisdom, and Charisma scores, as well as the properties of the cloak. This property can't be used again until the next dawn.
...
* When you cast the [[Meta/Homebrew/RAW/Character/Extra_Abilities/Spells/spell:Polymorph|polymorph]] spell using the *Verminshroud*, you can transform into a **giant wasp**.
...
* When you cast the [[Meta/Homebrew/RAW/Character/Extra_Abilities/Spells/spell:Polymorph|polymorph]] spell using the *Verminshroud*, you can transform into a **giant scorpion**.